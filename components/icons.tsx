...
export const ClipboardIcon: FC<IconProps> = (props) => (
  ...
  >
    <path
      ...
      d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v3.042m-7.332 0c-.055.194-.084.4-.084.612v3.042m0 9.75H13.5A2.25 2.25 0 0015.75 21v-2.625c0-.621-.504-1.125-1.125-1.125h-3.75c-.621 0-1.125.504-1.125 1.125V21a2.25 2.25 0 002.25 2.25h.375m-3.75-9.75c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125m-9.75 0h9.75"
    />
  </svg>
);
...
export const LoadingSpinnerIcon: FC<IconProps> = (props) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    fill="none"
    viewBox="0 0 24 24"
  ...
  >
    <path
      ...
      strokeLinejoin="round"
      strokeWidth={2}
      d="M12 4.75V6.25m0 11.5v1.5M17.25 6.75l-1.06 1.06M7.81 16.19l-1.06 1.06M20.25 12h-1.5M5.25 12h-1.5M17.25 17.25l-1.06-1.06M7.81 7.81l-1.06-1.06"
    />
  </svg>
);
...
export const DocumentDuplicateIcon: FC<IconProps> = (props) => (
    <svg 
        xmlns="http://www.w3.org/2000/svg" 
        fill="none" 
        viewBox="0 0 24 24" 
